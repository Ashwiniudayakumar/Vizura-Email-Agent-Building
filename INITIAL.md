I wnat to build an email reply agent for gmail.
...
The existing knowledge base in the csv file in the working direcory should be converted to a vector database and stored in supabase. You will have to perform RAG to fetch the relevant infor from the vector database

The implementation should happen in phases. So you should plan first, asky my preferences and then execute in phases.