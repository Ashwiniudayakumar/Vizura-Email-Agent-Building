...
-- HNSW gives high recall without list/probe tuning and works well even on a
-- small table like this (ivfflat with many lists would under-return at this size).
